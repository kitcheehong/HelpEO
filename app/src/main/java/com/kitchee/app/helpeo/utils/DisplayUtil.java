...
public class DisplayUtil {
    ...
    public static int px2dip(float pxValue) {
        final float scale = HelpEOApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        final float fontScale = HelpEOApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().scaledDensity;
